    ...
    <div className="min-h-screen bg-background flex">
      <div className="hidden lg:flex lg:w-1/2 gradient-primary items-center justify-center p-12">
        <div className="max-w-md">
          ...
          <h2 className="text-4xl font-bold text-primary-foreground mb-4">Welcome back to FairShare</h2>
          <p className="text-primary-foreground/70 text-lg">Pick up where you left off. Your groups and balances are waiting.</p>
        </div>
      </div>
